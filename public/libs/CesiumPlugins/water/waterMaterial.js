...
var waterMaterial = {
  waters: [],
  normalMapUrl: '/static/cesium-web-s/lib/CesiumPlugins/water/img/waterNormals.jpg', //水正常扰动的法线图
  //自定义区域的动态水效果,使用方法： geometryInstance 用于限定动态水域的范围
  apply: function (viewer, geometryInstance,frequency=8000.0,animationSpeed=0.02,amplitude=5.0, specularIntensity=0.8,normalMapUrl) {
    console.warn("normalMapUrl=============>");
        ...
        material: new Cesium.Material({
          fabric: {
            ...
            uniforms: {
              ...
              frequency: frequency,     //控制波数的数字。
              animationSpeed: animationSpeed,   //控制水的动画速度的数字。
              amplitude: amplitude,         //控制水波振幅的数字。
              specularIntensity: specularIntensity,  //控制镜面反射强度的数字。

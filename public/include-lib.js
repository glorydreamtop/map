...
(function () {
    ...
    function load() {
        ...
        var libsConfig = {
			...
			'jquery.easyui': [
               libpath + "jquery/easyui/slider.css",
               libpath + "jquery/easyui/jquery.easyui.min.js",
            ],
            'ztree': [
            ...
            'layer': [
              ...
              libpath + "layer/theme/hchx/layer.css",
            ...
            'cesium-hchx': [
                ...
                libpath + "cesium-hchx/hchx3d.css",
                libpath + "cesium-hchx/hchx3d.js",
            ],

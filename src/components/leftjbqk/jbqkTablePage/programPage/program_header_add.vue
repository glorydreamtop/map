			...
			<div class="reyuan_form">
				...
				<el-dialog :title="dialogTitle" :append-to-body="true" @close='closeDialog' :visible.sync="showFlag" v-model="showFlag"
				 class="newStyleDialog " custom-class="jbqk_add2_table1_dialog">
					<programHeaderAdd :dialog-type="fly2_dialogType" :dialog-table="tableItemData" v-on:showStudes="showStudescode"
					 :dialog-form="fly2_dialogForm" v-if="showFlag"></programHeaderAdd>
				</el-dialog>
			</div>

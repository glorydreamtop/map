			...
			<div class="reyuan_form">
							...
							<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="110px" class="demo-ruleForm">
								<el-row :gutter="20">
									<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
										<el-form-item label="工程类型1:" prop="Region">
									...
									<el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="12">
										<el-form-item label="高程范围:">
											<el-input v-model="ruleForm.AltitudeStart" :disabled="disabled" style="width: 45%;"></el-input>
											<span>--</span>
											<el-input v-model="ruleForm.AltitudeEnd" :disabled="disabled" style="width: 45%;"></el-input>
										</el-form-item>
									</el-col>
				...
				<el-dialog :title="dialogTitle" :append-to-body="true" @close='closeDialog' :visible.sync="showFlag" v-model="showFlag"
				 class="newStyleDialog " custom-class="jbqk_add2_table1_dialog">
					<businessItemAdd :dialog-type="fly2_dialogType" :dialog-table="tableItemData" v-on:showStudes="showStudescode"
					 :dialog-form="fly2_dialogForm" v-if="showFlag"></businessItemAdd>
				</el-dialog>
			</div>
...
<script>
	...
	import businessItemAdd from './business_item_add'
	export default {

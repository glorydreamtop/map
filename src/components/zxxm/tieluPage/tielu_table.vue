	...
	<div class="tableMain">
		...
		<div class="body_table_mian">
			<el-table v-loading="tableLoad"  :data="tableData" row-key="id" :tree-props="{children: 'children'}" border style="width: 100%" height="50vh">
				...
				<el-table-column prop="QQD" label="等级标准" width="100" align="center"> </el-table-column>
				<el-table-column prop="GLDJ" label="权属部门" align="center"> </el-table-column>
		...
		<div>
			<el-dialog :title="dialogTitle"  :append-to-body="true" @close='closeDialog' :visible.sync="showFlag" v-model="showFlag"
			 class="newStyleDialog " custom-class="jbqk_add_table1_dialog">
				<tieluHeaderAdd :dialog-type="dialogType" v-on:showStudes="showStudescode" :dialog-form="dialogForm" v-if="showFlag" ></tieluHeaderAdd>
			</el-dialog>
		</div>
	</div>
</template>
...
<script>
	...
	import tieluHeaderAdd from './tielu_header_add' 
	export default {
		name: "dianliTable",
		props: {},
		components: {

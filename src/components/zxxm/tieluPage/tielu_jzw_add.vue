			...
			<div class="reyuan_form">
				<el-form   :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
					...
					<el-form-item label="用途:" >
						<el-input v-model="ruleForm.YT" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>
					<el-form-item label="结构:" >
						<el-input v-model="ruleForm.JG" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>
					<el-form-item label="规格:" >
						<el-input v-model="ruleForm.GG" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>

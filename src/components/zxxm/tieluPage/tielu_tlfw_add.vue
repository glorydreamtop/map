		...
		<div class="element_main">
			<div class="reyuan_form">
				<el-form   :model="ruleForm" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
					...
					<el-form-item label="车站和机务段名称:" >
						<el-input v-model="ruleForm.CZHJWD" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>
					<el-form-item label="房屋用途结构:" >
						<el-input v-model="ruleForm.FWYTJG" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>
					<el-form-item label="建筑面积(㎡):" >
						<el-input v-model="ruleForm.JZMJ" :disabled="dialogType=='look'?true:false"></el-input>
					</el-form-item>

						...
						<div class="formeHeader">
							<el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
								<el-form-item label="地区类型:" prop="Region">
									<el-select v-model="ruleForm.Region" filterable :disabled="disabled" placeholder="请选择地区类型" class="input-200">
                                ...
                                <el-form-item label="线路名称:" prop="stationName">
                                	<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入线路名称"></el-input>
                                </el-form-item>
								...
								<el-form-item label="建成年月:" prop="stationName">
									 <el-date-picker class="input-200"   v-model="ruleForm.Town"type="date" placeholder="请选择日期"> </el-date-picker>
								</el-form-item>
						...
						<div class="formeBody">
							...
							<el-table :data="tableItemData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 ...
							 default-expand-all @row-click="rowClick">
								...
								<el-table-column prop="label" label="影响线段名称" align="center"></el-table-column>
								<el-table-column prop="Unit" label="运行管理机构" align="center"></el-table-column>
								<el-table-column prop="AttrNum" label="杆塔材质及数量" align="center"></el-table-column>
								<el-table-column prop="Remarks" label="起讫点及长度" align="center"></el-table-column>
								<el-table-column prop="Remarks" label="高程分布" align="center"></el-table-column>
								<el-table-column prop="Remarks" label="导线型号及截面积" align="center"></el-table-column>
								<el-table-column prop="FSFS" label="敷设方式" align="center"></el-table-column>
								<el-table-column prop="FSFS" label="供电范围" align="center"></el-table-column>
							</el-table>
						</div>
					</el-collapse-item>
						...
						<div class="formeHeader">
							<el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
						        ...
						        <el-form-item label="名称:" prop="stationName">
						        	<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入名称"></el-input>
						        </el-form-item>
								<el-form-item label="地点:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入地点"></el-input>
								</el-form-item>
								<el-form-item label="权属部门:" prop="stationName">
									<el-select v-model="ruleForm.Town" filterable :disabled="disabled" placeholder="请选择权属部门" @change="change_town"
									 class="input-200">
										<el-option :key="item.o_locationno" :label="item.o_locationdesc" :value="item.o_locationno" v-for="item in townData">
										</el-option>
									</el-select>
								...
								<el-form-item label="主管部门:" prop="stationName">
									<el-select v-model="ruleForm.Village" filterable :disabled="disabled" placeholder="请选择主管部门" @change="change_village"
									 class="input-200">
										<el-option :key="item.o_locationno" :label="item.o_locationdesc" :value="item.o_locationno" v-for="item in villageData">
										</el-option>
									</el-select>
								...
								<el-form-item label="电压等级:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入电压等级"></el-input>
								</el-form-item>
								<el-form-item label="容量:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入容量"></el-input>
								</el-form-item>
								<el-form-item label="建成年月:" prop="stationName">
									 <el-date-picker class="input-200"   v-model="ruleForm.Town"type="date" placeholder="请选择日期"> </el-date-picker>
								</el-form-item>
								<el-form-item label="供电范围:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入供电范围"></el-input>
								</el-form-item>
								<el-form-item label="出线间隔:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder="请输入出线间隔"></el-input>
								</el-form-item>
								<el-form-item label="其他:" prop="stationName">
									<el-input  class="input-200" v-model="ruleForm.Town" placeholder=""></el-input>
								</el-form-item>
			        	...
			        	<div class="formeBody">
			        		...
			        		<el-table :data="tableItemData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
			        		 ...
			        		 default-expand-all @row-click="rowClick">
			        			...
			        			<el-table-column prop="Unit" label="规格型号" align="center"></el-table-column>
			        			<el-table-column prop="AttrNum" label="单位" align="center"></el-table-column>
			        			<el-table-column prop="Remarks" label="数量" align="center"></el-table-column>
						...
						<div class="formeBody">
							...
							<el-table :data="tableItemData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 ...
							 default-expand-all @row-click="rowClick">
								...
								<el-table-column prop="Unit" label="结构" align="center"></el-table-column>
								<el-table-column prop="AttrNum" label="建筑面积" align="center"></el-table-column>
								<el-table-column prop="Remarks" label="数量" align="center"></el-table-column>
								<el-table-column prop="Remarks" label="备注" align="center"></el-table-column>

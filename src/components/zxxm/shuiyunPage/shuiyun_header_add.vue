		...
		<div class="element_main">
			<div class="reyuan_form">
				<el-collapse v-model="activeFormIndex">
					<el-collapse-item title="表基础信息" name="1">
						<div class="formeHeader">
							<el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-width="130px" class="demo-ruleForm">
								...
								<el-form-item label="名称:" prop="XLMC">
									<el-input class="input-200" v-model="ruleForm.MC" placeholder="请输入名称"></el-input>
								</el-form-item>
								
								<el-form-item label="等级:" prop="DJ">
									<el-input class="input-200" v-model="ruleForm.DJ" placeholder="请输入等级"></el-input>
								</el-form-item>
								...
								<el-form-item label="其他:" prop="QQD">
									<el-input class="input-200" v-model="ruleForm.QQD" placeholder="请输入其他"></el-input>
								</el-form-item>
					...
					<el-collapse-item title="内河航道、港口水工建筑物" name="2">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(0)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(0)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(0)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="tableItemData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 ...
							 default-expand-all @row-click="rowClick">
								<el-table-column type="JZWBH" label="编号" align="left"></el-table-column>
								<el-table-column prop="HDMC" label="航道名称" align="center"></el-table-column>
								<el-table-column prop="GKMC" label="港口名称" align="center"></el-table-column>
								<el-table-column prop="HDDJ" label="航道等级" align="center"></el-table-column>
								<el-table-column prop="DHSSMC" label="导航设施名称" align="center"></el-table-column>
								<el-table-column prop="DHSSGG" label="导航设施规格" align="center"></el-table-column>
								<el-table-column prop="DHSSSL" label="导航设施数量" align="center"></el-table-column>
					...
					<el-collapse-item title="设施设备" name="3">
						<div class="formeBody">
							...
							<el-table :data="bianDian_tableData" highlight-current-row border style="width: 100%" class="margin-top-m"
							 ...
							 row-key="value" default-expand-all @row-click="rowClick">
								<el-table-column prop="SBBH" label="编号" align="center"></el-table-column>
					...
					<el-collapse-item title="进港道路" name="4">
						<div class="formeBody">
							...
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 :row-class-name="tableRowClassName" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="value"
							 default-expand-all @row-click="rowClick">
								<el-table-column prop="DLBH" label="编号" align="center"></el-table-column>
								<el-table-column prop="CD" label="长度" align="center"></el-table-column>
								<el-table-column prop="KD" label="宽度" align="center"></el-table-column>
								<el-table-column prop="LMLX" label="路面类型" align="center"></el-table-column>
								

							</el-table>
						</div>
					</el-collapse-item>
					<el-collapse-item title="水运码头-房屋" name="5">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(3)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(3)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(3)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 :row-class-name="tableRowClassName" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="value"
							 default-expand-all @row-click="rowClick">
					...
					<el-collapse-item title="水运码头-附属建筑物" name="6">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(4)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(4)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(4)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 :row-class-name="tableRowClassName" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="value"
							 default-expand-all @row-click="rowClick">
								<el-table-column prop="JZWBH" label="编号" align="center"></el-table-column>
					...
					<el-collapse-item title="水运码头-其他建筑物" name="7">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(5)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(5)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(5)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 :row-class-name="tableRowClassName" :tree-props="{children: 'children', hasChildren: 'hasChildren'}" row-key="value"
							 default-expand-all @row-click="rowClick">
								<el-table-column prop="JZWBH" label="编号" align="center"></el-table-column>
					...
					<el-collapse-item title="水运码头-零星树木" name="8">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(5)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(5)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(5)" size="mini" icon="el-icon-delete" plain></el-button>
					...
					<el-collapse-item title="水运码头" name="9">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(5)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(5)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(5)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 ...
							 default-expand-all @row-click="rowClick">
								...
								<el-table-column prop="NTTL" label="年吞吐量" align="center"></el-table-column>
								<el-table-column prop="ZDMJ" label="占地面积" align="center"></el-table-column>
								<el-table-column prop="YYGLDW" label="运营管理单位" align="center"></el-table-column>
								<el-table-column prop="DCMJ" label="堆场面积" align="center"></el-table-column>
								<el-table-column prop="GDZC" label="固定资产" align="center"></el-table-column>
								<el-table-column prop="YDMC" label="引道名称" align="center"></el-table-column>
					
							</el-table>
						</div>
					</el-collapse-item>
					<el-collapse-item title="水运中转站" name="10">
						<div class="formeBody">
							<el-button size="mini" @click="addTableItem(5)" icon="el-icon-plus"></el-button>
							<el-button title="修改" @click="editTableItem(5)" size="mini" icon="el-icon-edit" plain></el-button>
							<el-button title="删除" @click="delTableItem(5)" size="mini" icon="el-icon-delete" plain></el-button>
							<el-table :data="jianZhu_tableData" highlight-current-row border style="width: 100%" class="margin-top-m" height="25vh"
							 ...
							 default-expand-all @row-click="rowClick">
								...
								<el-table-column prop="MC" label="名称" align="center"></el-table-column>
								<el-table-column prop="YYGLDW" label="运营管理单位" align="center"></el-table-column>
								<el-table-column prop="DHJMCJG" label="堆货及面层结构" align="center"></el-table-column>
								<el-table-column prop="LJDLDJ" label="连接道路等级" align="center"></el-table-column>
								<el-table-column prop="SBGG" label="设备规格" align="center"></el-table-column>
								<el-table-column prop="SBSL" label="设备数量" align="center"></el-table-column>
								<el-table-column prop="FWMJ" label="房屋面积" align="center"></el-table-column>
								<el-table-column prop="LSGX" label="隶属关系" align="center"></el-table-column>

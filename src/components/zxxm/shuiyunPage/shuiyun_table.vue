	...
	<div class="tableMain">
		...
		<div class="body_table_mian">
			<el-table v-loading="tableLoad"  :data="tableData" row-key="id" :tree-props="{children: 'children'}" border style="width: 100%" height="50vh">
				...
				<el-table-column prop="MC" label="名称" width="150" align="center"> </el-table-column>
				...
				<el-table-column prop="QQD" label="其他"  align="center"> </el-table-column>
		...
		<div>
			<el-dialog :title="dialogTitle"  :append-to-body="true" @close='closeDialog' :visible.sync="showFlag" v-model="showFlag"
			 class="newStyleDialog " custom-class="jbqk_add_table1_dialog">
				<shuiyunHeaderAdd :dialog-type="dialogType" v-on:showStudes="showStudescode" :dialog-form="dialogForm" v-if="showFlag" ></shuiyunHeaderAdd>
			</el-dialog>
		</div>
	</div>
</template>
...
<script>
	...
	import shuiyunHeaderAdd from './shuiyun_header_add' 
	export default {
		name: "dianliTable",
		props: {},
		components: {

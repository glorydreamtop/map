<template>
	<div class="tableMain">
		...
		<div class="body_table_mian">
			<el-table :data="tableData" border v-loading="tableLoad" element-loading-text="客官请稍后" element-loading-spinner="el-icon-loading" class="fixTable49"
                                 element-loading-background='#022333'  style="width: 100%" height="50vh">
				...
				<el-table-column prop="CityTownName" label="城市集镇名称" align="center"> </el-table-column>
				<el-table-column prop="Affiliation" label="隶属关系" width="100" align="center"> </el-table-column>
				<el-table-column prop="Nature" label="性质"  align="center"> </el-table-column>
